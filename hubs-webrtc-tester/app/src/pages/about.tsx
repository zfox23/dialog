...
const AboutPage = ({ }) => {
        ...
        <Layout>
            ...
            <div className='space-y-8 w-full'>
                <div id="introduction" className='mt-4 pt-4 w-full space-y-4'>
                    <h2 className='text-xl font-semibold hover:underline'><a href="#introduction">Introduction</a></h2>
                ...
                <div id="webrtc-primer" className='mt-4 pt-4 w-full space-y-4'>
                    <h2 className='text-xl font-semibold hover:underline'><a href="#webrtc-primer">What is WebRTC?</a></h2>
                    <Divider className='!mt-1' />
                ...
                <div id="communication-data-flow" className='mt-4 pt-4 w-full space-y-4'>
                    <h2 className='text-xl font-semibold hover:underline'><a href="#communication-data-flow">Communication Data Flow</a></h2>
                    <Divider className='!mt-1' />
                ...
                <div id="hubs-webrtc-libraries" className='mt-4 pt-4 w-full space-y-4'>
                    <h2 className='text-xl font-semibold hover:underline'><a href="#hubs-webrtc-libraries">Hubs' WebRTC Libraries</a></h2>
                    ...
                    <p><a className='underline' target="_blank" href='https://github.com/mozilla/hubs/blob/master/src/naf-dialog-adapter.js'><code>naf-dialog-adapter.js</code><ArrowTopRightOnSquareIcon className='h-4 w-4 ml-1 -top-0.5 relative inline-block' /></a>, the Hubs client code which communicates with Dialog, uses:</p>
                    <ul className='list-disc ml-5 !mt-1 space-y-1'>
                    ...
                    <div id="protoo-glossary" className='!mt-8 space-y-4'>
                        <h3 className='font-semibold text-lg'><a className="hover:underline" href="#protoo-glossary">Protoo - Glossary and Usage</a></h3>
                        <Divider className='!mt-1' />
                        ...
                        <p>The authors of the Protoo library have chosen specific names to refer to signaling-related concepts. In this section, we'll define the concepts that Protoo uses and explore how they're used in Hubs code.</p>

                        <div className='!mt-4 space-y-4'>
                            <h4><code className='font-semibold text-lg'>WebSocketTransport</code> <a className='underline text-xs' target="_blank" href='https://protoo.versatica.com/#websockettransport35'><code>(protoo docs)</code><ArrowTopRightOnSquareIcon className='h-3 w-3 ml-0.5 -top-0.5 relative inline-block' /></a></h4>
                                ...
                                <div className='space-y-4 !mt-0 w-full pl-2'>
                                    ...
                                    <div className='!mt-2 p-4 rounded-md bg-slate-100 dark:bg-slate-500/20 relative w-full'>
                                        ...
                                        <div className='z-10 relative space-y-2 w-full'>
                                            <p className='font-semibold'><code>WebSocketTransport</code> Usage</p>
                                            <p>From <code><a className='underline' target="_blank" href='https://github.com/mozilla/hubs/blob/master/src/naf-dialog-adapter.js'>naf-dialog-adapter.js<ArrowTopRightOnSquareIcon className='h-4 w-4 ml-1 -top-0.5 relative inline-block' /></a> &gt; DialogAdapter &gt; connect()</code>:</p>
    ...
    retry: { retries: 2 }
                ...
                <div id="peer-discovery" className='mt-4 pt-4 w-full space-y-4'>
                    <h2 className='text-xl font-semibold hover:underline'><a href="#peer-discovery">Peer Discovery</a></h2>
                    <Divider className='!mt-1' />
