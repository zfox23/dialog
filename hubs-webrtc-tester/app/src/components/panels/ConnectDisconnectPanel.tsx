    ...
    return (
        <div className='flex flex-col mb-8 p-6 pt-4 bg-slate-200 dark:bg-neutral-900 rounded-md items-center'>
            <div className='flex gap-1'>
                ...
                <button className='transition-all opacity-70 hover:opacity-100'><QuestionMarkCircleIcon className='w-6 h-6 text-slate-700 dark:text-slate-200' onClick={e => setShowConnectHelp(!showConnectHelp)} /></button>
            </div>
            {showConnectHelp ?
